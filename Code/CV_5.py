...
class SimpleNet(nn.Module):
    ...
    def __init__(self, num_classes=100):
        ...
        self.conv1 = nn.Conv2d(in_channels=3, out_channels=30, kernel_size=5,stride=3)
        self.relu = nn.ReLU()
        self.pool = nn.MaxPool2d(kernel_size=2, stride=2)

        self.conv2 = nn.Conv2d(in_channels=30, out_channels=80, kernel_size=5,stride=1)
        self.fc1 = nn.Linear(80* 1* 1, 120)# flatern
